...
public class ButtonMainConnectFaction extends GuiButton {
	...
	static {
		button = new ResourceLocation("textures/ow4rd/gui/faction.png");
	}

	public ButtonMainConnectFaction(final int p_i1020_1_, final int p_i1020_2_, final int p_i1020_3_, final int x2,
			final int y2, final String p_i1020_4_) {
		this(p_i1020_1_, p_i1020_2_, p_i1020_3_, 200, 20, x2, y2, p_i1020_4_);
	}

	public ButtonMainConnectFaction(final int p_i1021_1_, final int p_i1021_2_, final int p_i1021_3_, final int p_i1021_4_,
