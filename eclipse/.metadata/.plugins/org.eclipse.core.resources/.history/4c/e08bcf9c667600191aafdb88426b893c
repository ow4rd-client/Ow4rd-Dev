...
public class ButtonMainConnectCrossplay extends GuiButton {
	...
	static {
		button = new ResourceLocation("textures/ow4rd/gui/crossplay.png");
	}

	public ButtonMainConnectCrossplay(final int p_i1020_1_, final int p_i1020_2_, final int p_i1020_3_, final int x2,
			final int y2, final String p_i1020_4_) {
		this(p_i1020_1_, p_i1020_2_, p_i1020_3_, 200, 20, x2, y2, p_i1020_4_);
	}

	public ButtonMainConnectCrossplay(final int p_i1021_1_, final int p_i1021_2_, final int p_i1021_3_, final int p_i1021_4_,
			final int p_i1021_5_, final int x2, final int y2, final String p_i1021_6_) {
	...
	public void drawButton(final Minecraft p_146112_1_, final int p_146112_2_, final int p_146112_3_) {
		if (this.field_146125_m) {
			...
			drawRect(this.field_146128_h, this.field_146129_i, this.x2, this.y2, new Color(0, 0, 0, 150).getRGB());
			...
			Utils.drawImage(this.field_146128_h, this.field_146129_i, 100, 50, button);
			...
			if (this.packedFGColour != 0) {
				...
				drawRect(this.field_146128_h, this.y2 - 3, this.x2, this.y2, new Color(178,34,34).getRGB());
			} else {
	...
	public boolean func_146116_c(final Minecraft p_146116_1_, final int p_146116_2_, final int p_146116_3_) {
		return this.field_146124_l && this.field_146125_m && p_146116_2_ >= this.field_146128_h
